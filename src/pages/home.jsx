...
export default function Home() {
  ...
  { icon: Settings, title: 'Opener Repair & Installation', description: 'All major brands — belt-drive, chain-drive, and smart openers.', image: 'https://media.base44.com/images/public/6940c0d91636ce363ecbf035/2a7647266_d7286b14f_garage-door-opener.jpg' },
  { icon: Shield, title: 'Off-Track Repair', description: 'Rollers replaced and door re-aligned — most jobs completed in under 2 hours.', image: 'https://media.base44.com/images/public/6940c0d91636ce363ecbf035/2e9929575_8f122331d_generated_image.jpg' },
  { icon: Award, title: 'New Door Installation', description: 'Modern steel and raised-panel doors — transform your home\'s curb appeal.', image: 'https://media.base44.com/images/public/6940c0d91636ce363ecbf035/677d14b75_42ad8fe28_generated_image.jpg' },
  { icon: CheckCircle2, title: 'Full Tune-Up & Maintenance', description: 'Lubrication, balance check, hardware tightening — extends door life by years.', image: 'https://media.base44.com/images/public/6940c0d91636ce363ecbf035/edff3c555_55372ee69_generated_image.jpg' },
  ...
  return (
    <div className="min-h-screen bg-white pb-20 lg:pb-0">
      ...
      <section className="relative min-h-[75vh] flex items-center text-white overflow-hidden">
        ...
        {/* Dark overlay */}
        <div className="absolute inset-0" style={{ background: 'linear-gradient(rgba(10,30,80,0.75), rgba(10,30,80,0.68))' }} />
      ...
      <section id="contact-form" className="hidden md:block bg-blue-800 py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-white text-center mb-2">Contact Us For Service
