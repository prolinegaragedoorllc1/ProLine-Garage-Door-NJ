      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 text-xl">See what our customers are saying on Google</p>
          </div>

          <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-lg border border-slate-200">
            <iframe
              src="https://maps.google.com/maps?q=ProLine+Garage+Door+LLC+227+Sanzari+Pl+Maywood+NJ+07607&output=embed&hl=en"
              width="100%"
              height="500"
              style={{ border: 0 }}
              allowFullScreen=""
              ...
              title="ProLine Garage Door LLC on Google Maps"
            />
          </div>
          ...
          <div className="text-center mt-8">
            ...
            >
              <Button
                size="lg"
                className="bg-white text-slate-800 hover:bg-slate-100 border-2 border-slate-300 gap-3 text-lg px-8 py-6 shadow-sm"
              >
