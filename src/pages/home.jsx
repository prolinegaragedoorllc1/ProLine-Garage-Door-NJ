      ...
      >
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">Garage Door Repair In Your Area</h1>
      ...
      <section className="py-8 bg-white border-t border-slate-100">
        <div className="container mx-auto px-4 flex justify-center">
          <a
            ...
            className="inline-flex items-center gap-3 border border-slate-200 rounded-xl px-6 py-3 hover:bg-slate-50 transition-colors"
          >
            <GoogleLogo />
