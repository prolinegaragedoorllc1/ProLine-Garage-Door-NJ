      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold mb-4 text-white group-hover:scale-110 transition-transform">🚀</div>
              <p className="text-xl md:text-2xl text-blue-100 font-semibold">Fast & Reliable</p>
              <p className="text-sm text-blue-200 mt-2">Local Garage Door Service</p>
            </div>
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold mb-4 text-white group-hover:scale-110 transition-transform">⚡</div>
              <p className="text-xl md:text-2xl text-blue-100 font-semibold">Same-Day Service</p>
              <p className="text-sm text-blue-200 mt-2">Available</p>
            </div>
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold mb-4 text-white group-hover:scale-110 transition-transform">🤝</div>
              <p className="text-xl md:text-2xl text-blue-100 font-semibold">Customer-Focused</p>
              <p className="text-sm text-blue-200 mt-2">Garage Door Repairs</p>
            </div>
            <div className="group">
              <div className="text-3xl md:text-4xl font-bold mb-4 text-white group-hover:scale-110 transition-transform">📍</div>
              <p className="text-xl md:text-2xl text-blue-100 font-semibold">Serving</p>
              <p className="text-sm text-blue-200 mt-2">New Jersey</p>
            </div>
          </div>
        </div>
      </section>
